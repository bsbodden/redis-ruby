...
class CounterDSLTestPart2 < RedisRubyTestCase
  use_testcontainers!
  ...
  def test_exists_returns_false_when_key_does_not_exist
    ...
    refute_predicate counter, :exists?
  end
...
class CounterDSLTestPart3 < RedisRubyTestCase
  use_testcontainers!
  ...
  def test_rate_limiting_workflow
    ...
    flunk "Rate limit should not be exceeded" if limit.get > 100
  ...
  def test_metrics_collection_workflow
    ...
    assert_in_delta(20.0, error_rate)
