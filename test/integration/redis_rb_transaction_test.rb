...
# These tests mirror the redis-rb transaction tests to ensure compatibility
class RedisRbTransactionTest < Minitest::Test
  def setup
  ...
  def test_multi_exec_with_a_block_doesnt_return_replies_for_multi_and_exec
