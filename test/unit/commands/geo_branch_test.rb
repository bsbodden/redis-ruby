...
class GeoBranchTest < Minitest::Test
  def setup
    @client = GeoBranchTestMocks::MockClient.new
  end
...
class GeoBranchTestPart2 < Minitest::Test
  def setup
    @client = GeoBranchTestMocks::MockClient.new
  end
...
class GeoBranchTestPart3 < Minitest::Test
  def setup
    @client = GeoBranchTestMocks::MockClient.new
  end
...
class GeoBranchTestPart4 < Minitest::Test
  def setup
    @client = GeoBranchTestMocks::MockClient.new
  end
