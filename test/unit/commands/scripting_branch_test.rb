...
class ScriptingBranchTest < Minitest::Test
  ...
  def test_script_exists
    ...
    assert_equal ["SCRIPT", "EXISTS", "sha1", "sha2"], @client.last_command
  ...
  def test_script_flush_no_mode
    @client.script_flush
    assert_equal ["SCRIPT", "FLUSH", "SYNC"], @client.last_command
  end

  def test_script_flush_async
    @client.script_flush(:async)
    assert_equal ["SCRIPT", "FLUSH", "ASYNC"], @client.last_command
  end
  ...
  def test_script_kill
    @client.script_kill
    assert_equal ["SCRIPT", "KILL"], @client.last_command
  end

  # script_debug
  def test_script_debug
    @client.script_debug(:yes)
    assert_equal ["SCRIPT", "DEBUG", "YES"], @client.last_command
  end
