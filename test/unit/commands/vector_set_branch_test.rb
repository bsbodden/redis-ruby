...
class VectorSetBranchTest < Minitest::Test
  ...
  def test_vadd_with_array_vector
    ...
    assert_equal 1.0, cmd[4]
    assert_equal 2.0, cmd[5]
    assert_equal 3.0, cmd[6]
  ...
  def test_vsim_with_array_input
    @client.next_return = ["item1", "item2"]
  ...
  def test_vdim
    ...
    assert_equal ["VDIM", "vset"], @client.last_command
  end
  ...
  def test_vcard
    ...
    assert_equal ["VCARD", "vset"], @client.last_command
  end
  ...
  def test_vrem
    ...
    assert_equal 1, result
    assert_equal ["VREM", "vset", "item1"], @client.last_command
  end
  ...
  def test_vemb_without_raw
    ...
    assert_equal ["VEMB", "vset", "item1"], @client.last_command
  end
  ...
  def test_vemb_with_raw_array_ge_3_elements
    ...
    assert_equal ["VEMB", "vset", "item1", "RAW"], @client.last_command
  end
  ...
  def test_vlinks_without_with_scores
    @client.next_return = [["a", "b"], ["c", "d"]]
    result = @client.vlinks("vset", "item1")
    assert_equal [["a", "b"], ["c", "d"]], result
    assert_equal ["VLINKS", "vset", "item1"], @client.last_command
  end
  ...
  def test_vlinks_with_with_scores_array_of_arrays
    ...
    assert_equal ["VLINKS", "vset", "item1", "WITHSCORES"], @client.last_command
  ...
  def test_vinfo
    ...
    assert_equal ["VINFO", "vset"], @client.last_command
  end
  ...
  def test_vgetattr_with_result
    ...
    assert_equal ["VGETATTR", "vset", "item1"], @client.last_command
  end
  ...
  def test_vrandmember_fast_path
    ...
    assert_equal ["VRANDMEMBER", "vset"], @client.last_command
  end

  def test_vrandmember_with_count
    @client.next_return = ["item1", "item2", "item3"]
  ...
  def test_parse_vsim_response_plain
    @client.next_return = ["e1", "e2", "e3"]
    result = @client.vsim("vset", [1.0])
    assert_equal ["e1", "e2", "e3"], result
  end
