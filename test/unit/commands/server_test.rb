...
class ServerCommandsTest < Minitest::Test
  ...
  def test_lastsave
    @connection.expects(:call_direct).with("LASTSAVE").returns(1_700_000_000)

    assert_equal 1_700_000_000, @client.lastsave
  end
  ...
  def test_time
    ...
    assert_equal [1_700_000_000, 123_456], @client.time
  end
  ...
  def test_slowlog_get_count
    ...
    assert_empty @client.slowlog_get(10)
  end
  ...
  def test_memory_stats
    ...
    expected = { "peak.allocated" => 1_000_000 }
  ...
  def test_command_list
    ...
    @connection.expects(:call_1arg).with("COMMAND", "LIST").returns(%w[get set])

    assert_equal %w[get set], @client.command_list
  end
  ...
  def test_latency_latest
    ...
    assert_empty @client.latency_latest
  end
  ...
  def test_latency_history
    ...
    assert_empty @client.latency_history("command")
  end
  ...
  def test_module_list
    ...
    assert_empty @client.module_list
  end
