...
class Redis
  ...
  class PipelinedConnection
    ...
    # Delegate common commands
    # We need to include the same commands as the normal client
    # Each command returns a Future
  ...
  class MultiConnection
    ...
    # Common commands that return Futures
    ...
    # Server commands
    def info(section = nil)
      future = section ? call("INFO", section) : call("INFO")
      future.then { |result| parse_info(result) }
    end
